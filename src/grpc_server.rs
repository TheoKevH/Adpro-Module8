...
impl TransactionService for MyTransactionService {
    type GetTransactionStream = ReceiverStream<Result<TransactionResponse, Status>>;

    async fn get_transaction_history(
        &self,
        request: Request<TransactionRequest>,
    ) -> Result<Response<Self::GetTransactionStream>, Status> {
        ...
        // Return the transaction history as a stream
